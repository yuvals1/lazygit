...
type KeybindingBranchesConfig struct {
	...
	CopyBranchName           Keybinding `yaml:"copyBranchName"`
...
type KeybindingTagsConfig struct {
	CopyTagName Keybinding `yaml:"copyTagName"`
}
...
type KeybindingStashConfig struct {
	...
	CopyStashName Keybinding `yaml:"copyStashName"`
}
